                ...
                <div class="sjb-section">
                    <div class="sjb-content">
                        ...
                        <div class="sjb-form-group">
                            ...
                            <label><?php echo esc_html__('Enable the Job Category Filter', 'simple-job-board'); ?></label>
                        ...
                        <div class="sjb-form-group">
                            ...
                            <label><?php echo esc_html__('Enable the Job Type Filter', 'simple-job-board'); ?></label>
                        ...
                        <div class="sjb-form-group">
                            ...
                            <label><?php echo esc_html__('Enable the Job Location Filter', 'simple-job-board'); ?></label>
                        ...
                        <div class="sjb-form-group">
                            ...
                            <label><?php echo esc_html__('Enable the Search Bar', 'simple-job-board'); ?></label>
